"""A banna preferences survey written in Python"""
...
color_choices=('any', 'Green', 'Green-Yellow',
               'Yellow', 'Brown Spotted', 'Black'
               )
color_inp = tk.OptionMenu(
    root, color_var, *color_choices)

plantain_label = tk.Label(root, text='Do you east plantains?')
...
plantain_no_inp = tk.Radiobutton(plantain_frame, text='Eww, no!', value=False, variable=plantain_var)
...
def on_submit():
    ...
    if plantain_eater:
        ...
        message += 'May successfully avoid plantains!'
